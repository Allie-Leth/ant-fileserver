...
class FirmwareService:
    ...
    def upload_firmware(
        ...
        meta: dict = {
            ...
            "bootloader_version": payload.get("bootloader_version"),
            "partition_table_version": payload.get("partition_table_version"),
    ...
    def get_firmware_binary(
        ...
        """Retrieve the firmware binary from storage.
        ...
        Returns:
            Raw firmware binary bytes

        Raises:
            VersionNotFoundError: If the firmware version doesn't exist
        ...
        try:
            ...
            raise StorageError(f"Failed to retrieve firmware {key}: {e}") from e
